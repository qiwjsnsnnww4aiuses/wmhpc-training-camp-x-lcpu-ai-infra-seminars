...
// R fork: split K1/K2 launch entry points used by the carry-lookahead path.
// Kept in this translation unit so the original kernel headers are compiled
// once and the fork still emits the same SM80 MMA/TMA implementation.
#include "reduce_launch_impl.cuh"
